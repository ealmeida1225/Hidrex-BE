...
from apps.business_app.serializers.precipitation_concentration_index_by_area import (
    PrecipitationConcentrationIndexByAreaSerializer,
)
...
class PrecipitationConcentrationIndexByAreaViewSet(
