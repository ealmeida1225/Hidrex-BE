...
const url = "/business-gestion/diary-precipitation-classification/";
      ...
      columns: [
        {
          ...
          { data: "lower_limmit", title: "Límite inferior" },
          { data: "upper_limmit", title: "Límite superior" },
  ...
  if (button.data("type") == "edit") {
    ...
    axios
      ...
      .then(function (response) {
        ...
        form.elements.classification.value = element.classification;
        form.elements.upper_limmit.value = element.upper_limmit;
        form.elements.lower_limmit.value = element.lower_limmit;
      })
...
form.addEventListener("submit", function (event) {
  ...
  data.append("upper_limmit", document.getElementById("upper_limmit").value);
  data.append("lower_limmit", document.getElementById("lower_limmit").value);
